...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    return sorted(list(set(foods1) & set(foods2))) # return food in common
...
def every_other_item(items):
    ...
    return items[::2]   # returns every other item in list
...
def largest_n_items(items, n):
    ...
    if n != 0:
        n_largest_ints = sorted(items)[-n:]

    return n_largest_ints
